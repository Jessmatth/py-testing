...
def most_and_least_common_type(treats):
    ...
    >>> most_and_least_common_type([{'type': 'pizza'}, {'type': 'pizza'}, {'type': 'coke'}, {'type': 'coke'}])
    ('pizza', 'pizza')

    >>> most_and_least_common_type([{'type': 'pizza'}, {'type': 'pizza'}, {'type': 'pizza'}, {'type': 'pizza'}])
    ('pizza', 'pizza')

    >>> most_and_least_common_type([{'type': 'pizza'}])
    ('pizza', 'pizza')
